...
function RequestCardList({progress, isLoaded}) {
  ...
  return (
    <div className='space-y-2 mt-2'>
      ...
      <aside className='flex flex-row py-2 px-3 bg-violet-500 hover:bg-violet-600 transition-colors shadow-md -mx-2 rounded-md mb-4 text-neutral-200'>
        <div>
          <h2 className='text-xs font-bold mb-1'>SUBSCRIBE TODAY</h2>
          <p className='text-xs'>Get offline mode and other essential features.</p>
        </div>
        <p className='text-3xl ml-auto -mt-1 mr-2'>&gt;</p>
      </aside>
